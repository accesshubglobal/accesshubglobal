            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <SectionBlock title="1. Informations Personnelles" icon={User}>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  ...
                  <InfoRow label="Filière souhaité" value={val(selectedApp.majorInChina)} />
                  <InfoRow label="Employeur" value={val(selectedApp.currentEmployer)} />
              ...
              <SectionBlock title="4. Situation en Chine" icon={Globe} color="text-red-700">
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  ...
                  {selectedApp.inChinaNow && <>
                    <InfoRow label="École" value={val(selectedApp.chinaSchool)} />
