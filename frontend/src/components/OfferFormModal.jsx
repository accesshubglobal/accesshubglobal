    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {/* ── All fields except service fees — disabled in feesOnlyMode ── */}
          <fieldset disabled={feesOnlyMode} className={feesOnlyMode ? 'opacity-60 pointer-events-none' : ''}>
          ...
          {/* ── Service Fees — hidden for partners, always editable even in feesOnlyMode ── */}
          {!isPartner && (
            <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
              ...
              {feesOnlyMode && (
                <p className="text-xs text-amber-700 mb-3 flex items-center gap-1">
                  ✏ Seule cette section est modifiable dans ce mode révision
                </p>
              )}
              <div className="grid grid-cols-2 gap-4">
                <div>
