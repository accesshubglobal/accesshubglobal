...
All route logic is split into focused sub-modules under routers/:
  ...
  routers/auth.py      — Authentication (register, login, password-reset, agent auth, partner auth, employer auth)
  ...
  routers/employer.py  — Employer dashboard, job offers, applications
"""
